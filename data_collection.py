...
# # Function to get the closest Wikipedia article link using Google Custom Search API
...
#     # Extracting the first Wikipedia URL from the search results
...
#     # Scraping the main content of the Wikipedia article
#     paragraphs = soup.find_all('p')
#     content = "\n".join([para.get_text() for para in paragraphs])
#     return content

# # Function to save the article content to a .txt file
